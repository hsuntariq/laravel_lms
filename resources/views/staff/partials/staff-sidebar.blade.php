<ul class="d-flex flex-column bg-white p-4 gap-2" style="height:90vh;">
    ...
    ? 'text-white'
    : 'text-dark' }}" href="{{ route('staff-dashboard', ['id' => 1]) }}">
                Dashboard
            </a>
        </h6>
    </li>
    ...
    ? 'active'
    : 'text-dark bg-transparent text-dark' }}" type="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    : 'text-dark bg-transparent text-dark' }}" type="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <ul class="dropdown-menu">
            <li class="d-flex rounded-3 p-3 gap-3 align-items-center ">
                <div class="bi bi-plus"></div>
                <a class="text-decoration-none dropdown-item text-dark" href="{{ route('staff-add-batches')}}">
                    Add Batch
                </a>
            </li>
            <li class="d-flex rounded-3 p-3 gap-3 align-items-center ">
                <div class="bi bi-eye"></div>
                <a class="text-decoration-none text-dark dropdown-item" href="{{ route('staff-view-batches') }}">
                    View Batch
                </a>
            </li>
            <li class="d-flex rounded-3 p-3 gap-3 align-items-center ">
