    ...
    <li class="d-flex {{ collect(request()->segments())->contains(function ($segment) {
        ...
        <h6 class="m-0">
            <a class="text-decoration-none {{ collect(request()->segments())->contains(function ($segment) {
                ...
                ? 'text-white'
                : 'text-dark' }}" href="{{ route('student-dashboard', ['id' => auth()->user()->id]) }}">
                Dashboard
            </a>
        </h6>
    </li>
    <li class="d-flex rounded-3 p-3 gap-3 align-items-center {{ collect(request()->segments())->contains(function ($segment) {
        ...
        <h6 class="m-0">
            <a class="text-decoration-none {{ collect(request()->segments())->contains(function ($segment) {
                ...
                ? 'text-white'
                : 'text-dark' }}" href="{{ route('student-courses', ['id' => auth()->user()->id]) }}">
                Courses
            </a>
        </h6>
    </li>
    <li class="d-flex rounded-3 p-3 gap-3 align-items-center {{ collect(request()->segments())->contains(function ($segment) {
        ...
        <h6 class="m-0">
            <a class="text-decoration-none {{ collect(request()->segments())->contains(function ($segment) {
                ...
                ? 'text-white'
                : 'text-dark' }}" href="{{ route('student-assignments', ['id' => auth()->user()->id]) }}">
                Assignments
            </a>
        </h6>
    </li>
    <li class="d-flex rounded-3 p-3 gap-3 align-items-center {{ collect(request()->segments())->contains(function ($segment) {
        ...
        <h6 class="m-0">
            <a class="text-decoration-none {{ collect(request()->segments())->contains(function ($segment) {
                ...
                ? 'text-white'
                : 'text-dark' }}" href="{{ route('student-marks', ['id' => auth()->user()->id]) }}">
                Marks
            </a>
        </h6>
    </li>
    <li class="d-flex rounded-3 p-3 gap-3 align-items-center {{ collect(request()->segments())->contains(function ($segment) {
        ...
        <h6 class="m-0">
            <a class="text-decoration-none {{ collect(request()->segments())->contains(function ($segment) {
                ...
                ? 'text-white'
                : 'text-dark' }}" href="{{ route('student-attendance', ['id' => auth()->user()->id]) }}">
                Attendance
            </a>
        </h6>
    </li>
    <li class="d-flex rounded-3 p-3 gap-3 align-items-center {{ collect(request()->segments())->contains(function ($segment) {
        ...
        <h6 class="m-0">
            <a class="text-decoration-none {{ collect(request()->segments())->contains(function ($segment) {
                ...
                ? 'text-white'
                : 'text-dark' }}" href="{{ route('student-settings', ['id' => auth()->user()->id]) }}">
                Settings
            </a>
        </h6>
    </li>
